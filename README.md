...
## Variable Speed Update

I changed the game to have variable speed pipes. Starting speed of pipes is 5, for each 10 score pipe speed is increased from 1. I changed the equation by adding velocity of pipes as another input to the function. 

`jump if (W1 x A + W2 x B + W3 x C + Bias + W4 x Vel) > 0`

### Results 

<img src="screenshots/multispeed.png" width=200/> <img src="screenshots/multispeedAve.png" width=200/>
